        ...
        <div class="container">
            <div class="row mbn-40">
                ...
                <div class="footer-widget col-lg-3 col-md-6 col-12 mb-40">
                    ...
                    <p><a href="tel:0907294396">0907 294 396</a></p>
                    <p><a href="mailto:dangminhdat14@gmail.com">dangminhdat14@gmail.com</a></p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <p class="footer-copyright">© 2023 WonderKid World | Alright server <i class="fa fa-heart heart-icon"></i> By <a target="_blank" href="">Dustin Dat</a></p>
                </div>
            </div>
        </div>
